...
public final class LogMessages {
    ...
    public static final String LISTENING_CONNECTIONS = "Lobby Stage: Waiting for connections from players up to " + Constants.MIN_PLAYERS + " for " + Constants.MAX_TIME / 1000  + " seconds.";
